...
import (
	...
	"github.com/chetanmeniyabacncy/docker_microservice1/generallib"
	"github.com/chetanmeniyabacncy/docker_microservice1/lang"
	"github.com/chetanmeniyabacncy/docker_microservice1/models"
	"github.com/chetanmeniyabacncy/docker_microservice1/repositories"
	"github.com/chetanmeniyabacncy/docker_microservice1/validation"
...
func (h *BaseHandlerMongo) RabbitMQ(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("Checking a message func: ")
	...
	if err != nil {
		json.NewEncoder(w).Encode(ErrHandler("Failed to open a channel"))
		return
	}
	...
	if err != nil {
		json.NewEncoder(w).Encode(ErrHandler("Failed to consume"))
		return
	}
	fmt.Println("Checking a message: ")
	for d := range msgs {
