...
import (
	...
	"github.com/chetanmeniyabacncy/docker_microservice3/controllers"

	"github.com/chetanmeniyabacncy/docker_microservice3/config"
...
func main() {
	...
	company.HandleFunc("/rpcget", hmongo.RPCget).Methods("GET")
	company.HandleFunc("/grpc", hmongo.GRPC).Methods("GET")
	...
	log.Fatal(http.ListenAndServe(":5002", s))
