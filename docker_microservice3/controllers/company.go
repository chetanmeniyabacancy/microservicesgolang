...
import (
	...
	"github.com/chetanmeniyabacncy/docker_microservice3/generallib"
	"github.com/chetanmeniyabacncy/docker_microservice3/helloworld"
	"github.com/chetanmeniyabacncy/docker_microservice3/lang"
	"github.com/chetanmeniyabacncy/docker_microservice3/models"
	"github.com/chetanmeniyabacncy/docker_microservice3/repositories"
...
func (h *BaseHandlerMongo) RPCget(w http.ResponseWriter, r *http.Request) {
	...
	client, err := rpc.DialHTTP("tcp", os.Getenv("RPCHOST"))

	if err != nil {
		log.Fatal("Connection error: ", err)
	}
	err = client.Call("API.GetCompaniesMongoRpc", searchtext, &companieslist)
	if err != nil {
...
// HelloWorld returns Hello, World
func (h *BaseHandlerMongo) GRPC(w http.ResponseWriter, r *http.Request) {
	...
	sendmessageclient := helloworld.HelloRequest{Name: &sendmessage}

	responsemessage, err := c.SayHello(context.Background(), &sendmessageclient)
	if err != nil {
